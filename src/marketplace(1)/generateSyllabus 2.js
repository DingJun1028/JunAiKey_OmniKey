...
records: $;
{
    recordIds === null || recordIds === void 0 ? void 0 : recordIds.length;
}
");\\\\\\\\\\\\\\\n        this.context.loggingService?.logInfo(";
SyllabusGenerator;
generating;
syllabus(__makeTemplateObject([", { userId, collectionId, recordCount: recordIds?.length, options, correlationId: message.correlationId });\\\\\\\\\\\\\\\n\\\\\\\\\\\\n        try {\\\\\\\\\\\\\\n            // Delegate syllabus generation logic to the core method\\\\\\\\\\\\n            const generatedSyllabus = await this.generateFromKnowledge(userId, collectionId, recordIds, options);\\\\\\\\\\\\\\n\\\\\\\\\\\\n            if (!generatedSyllabus) {\\\\\\\\\\\\\\\n                 throw new Error('Failed to generate syllabus from knowledge.');\\\\\\\\\\\\\\\n            }\\\\\\\\\\\\n\\\\\\\\\\\\n            console.log("], [", { userId, collectionId, recordCount: recordIds?.length, options, correlationId: message.correlationId });\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\n\\\\\\\\\\\\\\\\\\\\\\\\n        try {\\\\\\\\\\\\\\\\\\\\\\\\\\\\n            // Delegate syllabus generation logic to the core method\\\\\\\\\\\\\\\\\\\\\\\\n            const generatedSyllabus = await this.generateFromKnowledge(userId, collectionId, recordIds, options);\\\\\\\\\\\\\\\\\\\\\\\\\\\\n\\\\\\\\\\\\\\\\\\\\\\\\n            if (!generatedSyllabus) {\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\n                 throw new Error('Failed to generate syllabus from knowledge.');\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\n            }\\\\\\\\\\\\\\\\\\\\\\\\n\\\\\\\\\\\\\\\\\\\\\\\\n            console.log("]))[SyllabusGenerator];
Syllabus;
generation;
complete.Title;
$;
