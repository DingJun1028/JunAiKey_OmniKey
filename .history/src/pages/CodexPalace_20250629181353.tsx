    ...
    <div className="container mx-auto p-4">
      <div className="bg-neutral-800/50 p-6 rounded-lg shadow-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {/* Boost.space 雙向同步 Link */}
            <Link to="/boostspace-sync" className="block p-6 bg-neutral-700/50 rounded-lg shadow hover:bg-yellow-700/40 transition">
                <div className="flex items-center gap-4 mb-4">
                    <Zap size={40} className="text-yellow-400"/>
                    <h3 className="text-xl font-semibold text-yellow-300">Boost.space 雙向同步</h3>
                </div>
                <p className="text-neutral-300 text-sm">同步 Boost.space 任務、知識、專案，支援雙向自動更新與衝突解決。</p>
            </Link>

            {/* Capacities 知識庫相容 Link */}
            <Link to="/capacities-compat" className="block p-6 bg-neutral-700/50 rounded-lg shadow hover:bg-indigo-700/40 transition">
                <div className="flex items-center gap-4 mb-4">
                    <BookText size={40} className="text-indigo-400"/>
                    <h3 className="text-xl font-semibold text-indigo-300">Capacities 知識庫相容</h3>
                </div>
                <p className="text-neutral-300 text-sm">導入/匯出 Capacities 格式，與多平台知識庫無縫整合。</p>
            </Link>
