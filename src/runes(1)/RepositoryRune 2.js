...
cloneRepo(__makeTemplateObject([", { runeId: this.rune.id, userId, error: error.message });\n            throw new Error("], [", { runeId: this.rune.id, userId, error: error.message });\\n            throw new Error("]));
Repository;
clone;
failed: $;
{
...
commitChanges(__makeTemplateObject([", { runeId: this.rune.id, userId, error: error.message });\n            throw new Error("], [", { runeId: this.rune.id, userId, error: error.message });\\n            throw new Error("]));
Repository;
commit;
failed: $;
{
...
pushChanges(__makeTemplateObject([", { runeId: this.rune.id, userId, error: error.message });\n            throw new Error("], [", { runeId: this.rune.id, userId, error: error.message });\\n            throw new Error("]));
Repository;
push;
failed: $;
{
...
pullChanges(__makeTemplateObject([", { runeId: this.rune.id, userId, error: error.message });\n            throw new Error("], [", { runeId: this.rune.id, userId, error: error.message });\\n            throw new Error("]));
Repository;
pull;
failed: $;
{
...
getRepoStatus(__makeTemplateObject([", { runeId: this.rune.id, userId, error: error.message });\n            throw new Error("], [", { runeId: this.rune.id, userId, error: error.message });\\n            throw new Error("]));
Repository;
status;
check;
failed: $;
...
listFilesInRepo(__makeTemplateObject([", { runeId: this.rune.id, userId, error: error.message });\n            throw new Error("], [", { runeId: this.rune.id, userId, error: error.message });\\n            throw new Error("]));
Repository;
file;
listing;
failed: $;
