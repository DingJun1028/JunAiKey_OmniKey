...
-message `} className="block text-neutral-400 text-xs font-semibold mb-1">Message:</label>
                        <input
                            id={`;
$;
{
...
-url `} className="block text-neutral-400 text-xs font-semibold mb-1">URL:</label>
                            <input
                                id={`;
$;
{
...
-method `} className="block text-neutral-400 text-xs font-semibold mb-1">Method:</label>
                            <select
                                id={`;
$;
{
...
-data - json `} className="block text-neutral-400 text-xs font-semibold mb-1">Request Body (JSON):</label>
                                  <textarea
                                     id={`;
$;
{
...
-scriptId `} className="block text-neutral-400 text-xs font-semibold mb-1">Script (Ability):</label>
                             <select
                                 id={`;
$;
{
...
-params - json `} className="block text-neutral-400 text-xs font-semibold mb-1">Parameters (JSON):</label>\
                                   <textarea\
                                      id={`;
$;
{
...
-runeId `} className="block text-neutral-400 text-xs font-semibold mb-1">Rune:</label>
                             <select
                                 id={`;
$;
{
...
-action `} className="block text-neutral-400 text-xs font-semibold mb-1">Action:</label>
                                  <select
                                      id={`;
$;
{
...
-prompt `} className="block text-neutral-400 text-xs font-semibold mb-1">Prompt:</label>
                        <input
                            id={`;
$;
{
...
-query `} className="block text-neutral-400 text-xs font-semibold mb-1">Query (Optional):</label>
                        <input
                            id={`;
$;
{
...
-notif - type `} className="block text-neutral-400 text-xs font-semibold mb-1">Type:</label>
                            <select
                                id={`;
$;
{
...
-notif - message `} className="block text-neutral-400 text-xs font-semibold mb-1">Message:</label>
                            <input
                                id={`;
$;
{
...
-notif - channel `} className="block text-neutral-400 text-xs font-semibold mb-1">Channel:</label>
                            <select
                                id={`;
$;
{
...
-goalId `} className="block text-neutral-400 text-xs font-semibold mb-1">Goal:</label>
                             <select
                                 id={`;
$;
{
...
-krId `} className="block text-neutral-400 text-xs font-semibold mb-1">Key Result:</label>
                                  <select
                                      id={`;
$;
{
...
-currentValue `} className="block text-neutral-400 text-xs font-semibold mb-1">Current Value:</label>\
                                  <input\
                                      id={`;
$;
{
...
-json `} className="block text-neutral-400 text-xs font-semibold mb-1">Action Details (JSON):</label>
                         <textarea
                             id={`;
$;
{
