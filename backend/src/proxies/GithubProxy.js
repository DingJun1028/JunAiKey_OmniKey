...
exports.GithubProxy = void 0;
var core_1 = require("@octokit/core");
var GithubProxy = /** @class */ (function () {
    function GithubProxy(token) {
        this.octokit = new core_1.Octokit({ auth: token });
    }
    GithubProxy.prototype.fetchFile = function (owner_1, repo_1, path_1) {
        return __awaiter(this, arguments, void 0, function (owner, repo, path, ref) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.octokit.request('GET /repos/{owner}/{repo}/contents/{path}', {
                                owner: owner,
                                repo: repo,
                                path: path,
                                ref: ref,
                    ...
                    case 1:
                        ...
                        if (res.status === 200 && res.data && 'content' in res.data) {
                            return [2 /*return*/, Buffer.from(res.data.content, 'base64').toString('utf-8')];
                        }
