...
for (message; $; { type }(Correlation, ID, $, { correlationId }))
    : `, error);
...
Gateway;
received;
GET / api / v1 / knowledge `, { userId, query: options });
...
Gateway;
received;
POST / api / v1 / knowledge / search `, { userId, query: { query, ...options } });
...
received;
PUT / api / v1 / knowledge / ;
recordId `, { userId, recordId, updates });
