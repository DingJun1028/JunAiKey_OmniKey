...
Processing;
webhook;
event `, { userId: targetUserId, source: eventPayload.source, type: eventPayload.type, correlationId: message.correlationId });\\\
\\\n\\\n        try {\\\
...
event;
processed;
successfully `, { userId: targetUserId, source: eventPayload.source, type: eventPayload.type, correlationId: message.correlationId });\
\
\
...
processing;
webhook;
event `, { userId: targetUserId, source: eventPayload.source, type: eventPayload.type, correlationId: message.correlationId, error: error.message });\
\
