...
readFile `, { runeId: this.rune.id, userId, params });
...
readFile `, { runeId: this.rune.id, userId, error: error.message });
            throw new Error(`;
File;
read;
failed: $;
...
writeFile `, { runeId: this.rune.id, userId, params: { filePath: params?.filePath, contentSize: params?.content?.length } });
...
writeFile `, { runeId: this.rune.id, userId, error: error.message });
            throw new Error(`;
File;
write;
failed: $;
...
deleteFile `, { runeId: this.rune.id, userId, params });
...
deleteFile `, { runeId: this.rune.id, userId, error: error.message });
            throw new Error(`;
File;
deletion;
failed: $;
...
listFiles `, { runeId: this.rune.id, userId, params });
...
listFiles `, { runeId: this.rune.id, userId, error: error.message });
            throw new Error(`;
File;
listing;
failed: $;
...
mergeAndWriteFile `, { runeId: this.rune.id, userId, params: { filePath: params?.filePath, newContentSize: params?.newContent?.length, mergeStrategy: params?.mergeStrategy } });
...
mergeAndWriteFile `, { runeId: this.rune.id, userId, error: error.message });
            throw new Error(`;
File;
merge;
and;
