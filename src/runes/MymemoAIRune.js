 ...
 */
var MymemoAIRune = /** @class */ (function () {
    function MymemoAIRune(context, rune) {
        var _a, _b;
        this.context = context;
        this.rune = rune;
        console.log("[Rune] MymemoAIRune initialized for ".concat(rune.name, "."));
        // Validate configuration (e.g., check if API key is available)
        if (!((_a = this.rune.configuration) === null || _a === void 0 ? void 0 : _a.apiKey)) {
            console.warn("[Rune] MymemoAIRune ".concat(rune.name, " is missing API key in configuration."));
            (_b = this.context.loggingService) === null || _b === void 0 ? void 0 : _b.logWarning("MymemoAIRune missing API key", { runeId: rune.id });
     ...
     */
    MymemoAIRune.prototype.callAPI = function (params, userId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        _d.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, ((_b = this.context.apiProxy) === null || _b === void 0 ? void 0 : _b.callMymemoAIAPI(params.endpoint, params.method, params.data, params.config))];
                    case 2:
                        result = _d.sent();
                    ...
                    case 3:
                        ...
                        throw new Error("Mymemo.ai API call failed: ".concat(error_1.message));
     ...
     */
    MymemoAIRune.prototype.updateConfiguration = function (config) {
...
exports.MymemoAIRune = MymemoAIRune;
