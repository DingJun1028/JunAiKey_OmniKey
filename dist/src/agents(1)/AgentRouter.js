...
recipient ` field are for the router.
        // The MessageBus will check for `;
recipient `. If present, it sends to the router. If not, it broadcasts.
...
message;
without;
recipient. `, { messageType: message.type, correlationId: message.correlationId, sender: message.sender });\
