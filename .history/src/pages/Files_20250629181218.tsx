...
const Files: React.FC = () => {
  ...
  const fetchEntries = async (dirPath: string) => {
      ...
      try {
          ...
          setError(`Failed to load directory entries: ${err.message}`);
  ...
  useEffect(() => {
    ...
    const handleSaveFile = async () => {
        ...
        try {
            ...
            alert(`File ${viewingFile} saved successfully!`);
    ...
    const handleCreateNewFile = async (e: React.FormEvent) => {
     ...
     const handleCreateNewDirectory = async (e: React.FormEvent) => {
        ...
        setError(null);
        try {
            // Use the FileService to create the directory.
            // This assumes a `createDirectory` method exists in FileService.
            await fileService.createDirectory(path.join(currentDir, newDirName.trim()), userId);

            alert(`Directory ${path.join(currentDir, newDirName.trim())} created successfully!`);
            // Reset form and refetch entries
